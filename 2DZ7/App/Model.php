...
abstract class Model
{
    ...
    public static function findAll()
    {
        ...
        //return $db->queryEach($sql, static::class ); //реализация с использованием метода queryEach
    ...
    abstract public function fill(array $data);  //по заданию-метод должен создаваться в базовом классе
}
