...
<table>
    ...
    <tr>
        <form action="/2DZ2/update.php" method="post">
        ...
        <td>
            <form action="/2DZ2/delete.php" method="post">
...
<br>
<form action="/2DZ2/insert.php" method="post">
...
<br>
<a href="/2DZ2/index.php"><button>На главную</button></a>
</body>
</html>
